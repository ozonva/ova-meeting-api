...
// Source: github.com/ozonva/ova-meeting-api/internal/producer (interfaces: Producer)
...
import (
	...
	producer "github.com/ozonva/ova-meeting-api/internal/producer"
	reflect "reflect"
)
...
func (m *MockProducer) Send(arg0 string, arg1 producer.Event) error {
	m.ctrl.T.Helper()
